...
class Ui_AddItem(object):
    def setupUi(self, AddItem):
        ...
        self.gridLayout.addWidget(self.lineEdit_item_type, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_item_type, 2, 1, 1, 1)
        ...
        self.lineEdit_quantity_items = QLineEdit(self.frame_6)
        self.lineEdit_quantity_items.setObjectName(u"lineEdit_quantity_items")
        self.lineEdit_quantity_items.setMaximumSize(QSize(50, 16777215))

        self.gridLayout_7.addWidget(self.lineEdit_quantity_items, 1, 0, 1, 1)

        self.label_item_type_2 = QLabel(self.frame_6)
        self.label_item_type_2.setObjectName(u"label_item_type_2")
        self.label_item_type_2.setMaximumSize(QSize(16777215, 20))

        self.gridLayout_7.addWidget(self.label_item_type_2, 0, 1, 1, 1)

        self.lineEdit_quantity_stacks = QLineEdit(self.frame_6)
        self.lineEdit_quantity_stacks.setObjectName(u"lineEdit_quantity_stacks")
        self.lineEdit_quantity_stacks.setMaximumSize(QSize(50, 16777215))

        self.gridLayout_7.addWidget(self.lineEdit_quantity_stacks, 0, 0, 1, 1)

        self.label_item_type_4 = QLabel(self.frame_6)
        self.label_item_type_4.setObjectName(u"label_item_type_4")
        self.label_item_type_4.setMaximumSize(QSize(16777215, 20))

        self.gridLayout_7.addWidget(self.label_item_type_4, 1, 1, 1, 1)


        self.gridLayout.addWidget(self.frame_6, 10, 1, 1, 1)

        self.label_quantity = QLabel(self.frame_5)
        self.label_quantity.setObjectName(u"label_quantity")

        self.gridLayout.addWidget(self.label_quantity, 9, 1, 1, 1)

        self.label_material = QLabel(self.frame_5)
        self.label_material.setObjectName(u"label_material")

        self.gridLayout.addWidget(self.label_material, 0, 1, 1, 1)
        ...
        QWidget.setTabOrder(self.lineEdit_material, self.lineEdit_item_type)
        QWidget.setTabOrder(self.lineEdit_item_type, self.lineEdit_quantity_stacks)
        QWidget.setTabOrder(self.lineEdit_quantity_stacks, self.lineEdit_quantity_items)
        QWidget.setTabOrder(self.lineEdit_quantity_items, self.pushButton_add)
    ...
    def retranslateUi(self, AddItem):
        ...
        self.label_item_type_2.setText(QCoreApplication.translate("AddItem", u"Stacks", None))
        self.label_item_type_4.setText(QCoreApplication.translate("AddItem", u"items", None))
