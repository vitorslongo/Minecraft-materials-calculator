...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        if (self.tableWidget_calculator.columnCount() < 6):
            self.tableWidget_calculator.setColumnCount(6)
        ...
        self.tableWidget_calculator.setHorizontalHeaderItem(5, __qtablewidgetitem5)
        ...
        self.tableWidget_results.setHorizontalHeaderItem(0, __qtablewidgetitem6)
        __qtablewidgetitem7 = QTableWidgetItem()
        self.tableWidget_results.setHorizontalHeaderItem(1, __qtablewidgetitem7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"Items", None))
        ___qtablewidgetitem2 = self.tableWidget_calculator.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Stacks", None))
        ___qtablewidgetitem3 = self.tableWidget_calculator.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Base name", None))
